...
### **Q1 & Q2: Explain the role of the government as a planning and regulatory agency for Environmental Management. Enlist 3 points for its regulatory role.**
...
### **Q3: How is CSR related to Environmental Management? Explain with an example. (2024)**

**1. Introduction**
Corporate Social Responsibility (CSR) is a business model in which companies integrate social and environmental concerns into their business operations and interactions with stakeholders. 

**2. Relationship between CSR and Environmental Management**
While Environmental Management Systems (like ISO 14001) are the *technical tools* used to control a company's ecological footprint, CSR is the overarching *ethical and corporate policy* that drives the adoption of these systems. 
* **The Triple Bottom Line:** CSR mandates that companies focus not just on 'Profit', but also on 'People' and the 'Planet'. Environmental management fulfills the 'Planet' aspect.
* **Beyond Compliance:** Standard environmental management is often done just to meet legal limits. CSR pushes companies to go *beyond* legal compliance to actively restore the environment.
* **Legal Mandate (India):** Under the Companies Act, 2013, large companies are legally required to spend 2% of their average net profits on CSR. A massive portion of this is directed toward environmental management projects.

**3. Example**
* **ITC Limited:** Under its CSR initiatives, ITC has implemented massive environmental management programs like its **Afforestation Programme**. It doesn't just manage its own factory waste; it actively greens wastelands, making the company \"carbon positive,\" \"water positive,\" and \"solid waste recycling positive\" for over a decade.
...
* **Resource Security:** Ensures the long-term availability of raw materials (e.g., a paper company investing in sustainable forestry ensures it never runs out of wood).
